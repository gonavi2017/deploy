...
<jsp:useBean id="constants" class="jetbrains.buildServer.dotnetTools.server.dupFinder.DupFinderConstantsBean"/>
...
<l:settingsGroup title="Duplicate Searcher Settings" className="advancedSetting">
  ...
  <tr class="advancedSetting">
    <th>
      <label>Code fragments comparison: <bs:help file="Duplicates+Finder+%28.NET%29" anchor="fragComp"/></label>
    </th>
    <td>
  ...
  <tr class="advancedSetting">
    <th>
      <label for="${constants.debugKey}">Enable debug output: <bs:help file="Duplicates+Finder+%28.NET%29" anchor="debug"/></label>
    </th>
    <td>
  ...
  <tr class="advancedSetting">
    <th><label for="${constants.customCommandlineKey}">Additional dupFinder.exe arguments: <bs:help file="Duplicates+Finder+%28.NET%29" anchor="cmdArgs"/></label></th>
    <td>
      <props:multilineProperty name="${constants.customCommandlineKey}" linkTitle="Commandline" cols="60" rows="5" note="Additional commandline parameters to add to calling dupFinder.exe separated by new lines."/>
    </td>
  </tr>
