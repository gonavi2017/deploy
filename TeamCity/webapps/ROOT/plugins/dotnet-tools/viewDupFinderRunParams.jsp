...
<div class="parameter">
  Path to dupFinder.exe home: <jsp:include page="/tools/selector.html?name=${constants.cltPathKey}&class=longField&view=1"/>
</div>
...
<div class="parameter">
  Additional dupFinder.exe arguments: <strong><props:displayValue name="${constants.customCommandlineKey}" showInPopup="${true}"/></strong>
</div>
